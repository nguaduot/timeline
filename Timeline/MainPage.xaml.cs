    ...
    public sealed partial class MainPage : Page {
        ...
        private async void ViewSettings_ContributeChanged(object sender, EventArgs e) {
            ...
            if (res == ContentDialogResult.Primary) {
                ...
                bool status = await Api.Contribute(req);
                if (status) {
